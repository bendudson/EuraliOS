...
- [X] Programs and drivers in user space (Ring 3), with syscalls to
...
- [X] A basic shell
- [ ] A basic text editor
- [ ] Optional per-process virtual file system (VFS), providing
      capability-based security and user isolation
- [ ] Keyboard input with adjustable layout and UTF-8 language support
      (e.g. Pinying input)
...
- [[./doc/journal/22-ramdisk.org][22. RAMdisk driver]] to store files and develop the filesystem API,
  ...
  programs.
- [[./doc/journal/22-ramdisk.org][22. Interrupts and a better keyboard]]: Enabling user programs to receive
